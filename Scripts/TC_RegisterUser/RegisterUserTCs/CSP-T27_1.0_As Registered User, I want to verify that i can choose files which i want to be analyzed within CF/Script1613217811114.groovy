...
String fileNameWithExten = excelTestData.getValue(2, 136)

String existedFileName = excelTestData.getValue(3, 136)

CustomKeywords.'customKeywords.commanFunctions.UploadReqFile'(fileNameWithExten, existedFileName)

WebUI.click(findTestObject('Object Repository/SelectTheFilesPopUp/SelectSecondCheckBox'))

WebUI.click(findTestObject('Object Repository/SelectTheFilesPopUp/SelectThardCheckBox'))
