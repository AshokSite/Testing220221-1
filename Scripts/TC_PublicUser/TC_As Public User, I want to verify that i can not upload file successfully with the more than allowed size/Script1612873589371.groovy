...
String MaxFileSize = excelTestData.getValue(4, 144)
...
String fileNameWithExten = excelTestData.getValue(2, 144)

String existedFileName = excelTestData.getValue(3, 144)
...
String ErrorPopUp = excelTestData.getValue(5, 144)
