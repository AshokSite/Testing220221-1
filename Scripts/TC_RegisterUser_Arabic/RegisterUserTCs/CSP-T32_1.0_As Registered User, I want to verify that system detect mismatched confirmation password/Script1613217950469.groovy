...
String CurrentPwd  = excelTestData.getValue(2, 71)

String NewPwd  = excelTestData.getValue(3, 71)

String ConfimPwd  = excelTestData.getValue(4, 71)

String PwdChangeErrorMsg  = excelTestData.getValue(5, 71)
