...
String CurrentPwd  = excelTestData.getValue(2, 83)

String NewPwd  = excelTestData.getValue(3, 83)

String ConfimPwd  = excelTestData.getValue(4, 83)

String PwdChangeErrorMsg  = excelTestData.getValue(5, 83)
