...
WebUI.click(findTestObject('Object Repository/AddOrganizationPage/SubscriptionTypeClick'))
WebUI.click(findTestObject('Object Repository/AddOrganizationPage/TrialSubOption'))

String strThree = CustomKeywords.'customKeywords.commanFunctions.getRandomAlphaString'(5)
String name = 'testName_'+ strThree

WebUI.sendKeys(findTestObject('Object Repository/AddOrganizationPage/TargetName'), name)

String strFour = CustomKeywords.'customKeywords.commanFunctions.getRandomAlphaString'(5)
String url = 'https://detect.test'+ strFour

WebUI.sendKeys(findTestObject('Object Repository/AddOrganizationPage/TargetURL'), url)
...
String strFive = num.toString()

WebUI.sendKeys(findTestObject('Object Repository/AddOrganizationPage/CalSelectDurationInput'), strFive)
